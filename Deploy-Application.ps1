...
Try {
	...
	[string]$appVendor = 'TechnoPro'
	[string]$appName = 'ClockWork'
	[string]$appVersion = '5.18.7.5'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '03/29/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# Uninstall old 5.15.12 version
		Execute-MSI -Action Uninstall -Path '{82EAA592-F5A1-4FB8-8B27-04B84738EAED}'
		...
		Execute-MSI -Action 'Install' -Path "$dirFiles\ClockWork 5.18.7.5.msi" -Parameters 'REBOOT=ReallySuppress /QN'
		...
		Copy-File -Path "$dirFiles\ClockWork2.ini" -Destination "$envProgramFilesX86\TechnoPro Computer Solutions\ClockWork5\ClockWork2.ini"
